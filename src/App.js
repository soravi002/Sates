  ...
  render() {
    ...
    return (
      <div style={{ alignItems: 'center', justifyContent: 'center', display: 'flex', flexDirection: 'column' }}>
        <h1 style={{color: 'whitesmoke'}}>Clique sur le bouton pour voir le bg</h1>
        ...
        <p style={{position:'relative', top: '50px', color: 'whitesmoke', fontFamily: 'cursive'}}>Elapsed Time (tkt, c'est normal que tu sois rester si longtemps): {elapsedTime} seconds</p>
      </div>
    );
  }
}
